...
public class Raid {
	 ...
	 */
	public int getUserNumberInRole(String role) {
		int inRole = 0;
	 ...
	 * @param spec
	 *            The specialization they are playing
	 * @param role
	 *            The role they will be playing in the raid
	 * @param db_insert
	 ...
	 * attempts to insert it into the database, if needed Then it adds them to
	 * list of raid users' flex roles with their flex role
	 * 
	 * @param id
	 *            The id of the user
	 * @param name
	 ...
	 *            The specialization they are playing
	 * @param role
	 *            The flex role they will be playing in the raid
	 * @param db_insert
	 *            Whether or not the user should be inserted. This is false when
	 *            the roles are loaded from the database.
	 * @return true if the user was added, false otherwise
	 ...
	 * @return True if they are in the raid, false otherwise
	 */
	public boolean isUserInRaidByName(String name) {
		for (Map.Entry<RaidUser, String> entry : userToRole.entrySet()) {
	 ...
	 * them from the raid and any flex roles they are in
	 * 
	 * @param id
	 *            The user's id
	 */
	...
	public void removePossibleRaidersOnRoleChange(Guild guild){
		...
		for (Member member : members) {
			if(this.isUserInRaidByName(member.getUser().getName()) && !PermissionsUtil.hasRaiderRole(member)) {
	 ...
	 * 
	 * @param name
	 *            The name of the user being removed
	 */
